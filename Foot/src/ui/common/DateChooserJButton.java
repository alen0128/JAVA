 ...
 * @company:NEUSOFT
 * @Title:日期选择控件
 * @Description:在原有基础上修改了以下内容： 1. 将容器由Frame改为了Dialog，以便在基于对话框的程序中也能够使用 2.
 *                             将最小日期由1980改为了1950，考虑到目前球员的出生日期可能早于1980年 3.
 *                             将初始显示格式设置为 yyyy年MM月dd日 格式，原有的小时去掉了，不适合于出生日期字段
 */
